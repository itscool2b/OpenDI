...
int main() {
    ...
    double result1 = exponents(2.0, 3.0);
    printf("2^3 = %.2f (expected: 8.00)\n", result1);
    
    // Test zero exponent
    double result2 = exponents(5.0, 0.0);
    printf("5^0 = %.2f (expected: 1.00)\n", result2);
    
    // Test negative exponent
    double result3 = exponents(2.0, -2.0);
    printf("2^-2 = %.4f (expected: 0.2500)\n", result3);
    
    // Test fractional exponent
    double result4 = exponents(4.0, 0.5);
    printf("4^0.5 = %.2f (expected: 2.00)\n", result4);
    
    // Test base zero
    double result5 = exponents(0.0, 5.0);
